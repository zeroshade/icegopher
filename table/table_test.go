...
import (
	...
	"github.com/zeroshade/icegopher/internal"
...
func (t *TableTestSuite) TestSchema() {
	t.True(t.tbl.Schema().Equals(icegopher.NewSchemaWithIdentifiers(1, []int{1, 2},
...
func (t *TableTestSuite) TestPartitionSpec() {
	t.Equal(icegopher.NewPartitionSpec(
		icegopher.PartitionField{SourceID: 1, FieldID: 1000, Transform: icegopher.IdentityTransform{}, Name: "x"},
	), t.tbl.Spec())
}
...
func (t *TableTestSuite) TestSortOrder() {
	t.Equal(table.SortOrder{
		...
		Fields: []table.SortField{
			{SourceID: 2, Transform: icegopher.IdentityTransform{}, Direction: table.SortASC, NullOrder: table.NullsFirst},
			{SourceID: 3, Transform: icegopher.BucketTransform{N: 4}, Direction: table.SortDESC, NullOrder: table.NullsLast},
		},
	}, t.tbl.SortOrder())
}

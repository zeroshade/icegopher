...
var sortOrder = table.SortOrder{
	...
	Fields: []table.SortField{
		{SourceID: 19, Transform: icegopher.IdentityTransform{}, NullOrder: table.NullsFirst},
		{SourceID: 25, Transform: icegopher.BucketTransform{N: 4}, Direction: table.SortDESC},
		{SourceID: 22, Transform: icegopher.VoidTransform{}, Direction: table.SortASC},
	},
}
